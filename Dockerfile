...
RUN apt-get update \
        ...
        && rm -rf /var/lib/apt/lists/* \
        && wget -O pgadmin4-1.0b4-py2-none-any.whl "https://ftp.postgresql.org/pub/pgadmin3/pgadmin4/v1.0-beta4/pip/pgadmin4-1.0b4-py2-none-any.whl" \
        && pip install pgadmin4-1.0b4-py2-none-any.whl \
        && rm pgadmin4-1.0b4-py2-none-any.whl \
